...
This guide covers the Adcyma sign-up process from account creation to tenant configuration.
...
* Users in the old group but not in the new one will be removed from Adcyma and will no longer be managed by the system
* Users in the old group but not in the new one will no longer be available in Adcyma. For example, you won't be able to assign them as managers for other users
