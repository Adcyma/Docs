...
For user management, search for and select **User.ReadWrite.All**. This allows Adcyma to create, update, and deprovision Entra ID users.

For group management, search for and select **Group.ReadWrite.All**. This allows Adcyma to manage your groups.

For sign-in activity, search for and select **AuditLog.Read.All**. This allows Adcyma to read last sign-in timestamps shown in the People Hub.

For account enable/disable, search for and select **User.EnableDisableAccount.All**. This allows Adcyma to enable and disable user accounts.
