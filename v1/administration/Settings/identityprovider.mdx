...
:::info
Exchange authentication is optional and only required if you want Adcyma to perform Exchange Online operations. See the full walkthrough: [Connecting Exchange Online](../../userguides/exchangecertificate).
:::
...
You can **Suspend** and **Reactivate** agents from here. See the full walkthrough: [Installing the Active Directory Agent](../../userguides/installadagent).
