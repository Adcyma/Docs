...
import emailTemplatesImg from '@site/static/img/EmailTemplates2026.jpg';
...
<br/>
<Image img={emailTemplatesImg} alt="Email Templates editor" className="doc-screenshot" />
<br/><br/>
...
**Body**
The email body. The editor supports bold, italic, underline, bullet lists, and numbered lists. Use the **Variable** dropdown to insert placeholders at the cursor position, or type them directly as `{{variable_name}}`.
