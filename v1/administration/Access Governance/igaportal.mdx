...
If you own any dynamic groups, this section shows them with options to manage the **Always Include** and **Always Exclude** override lists. This lets you handle exceptions without modifying the underlying rules. For example, you can add a contractor who doesn't match the standard criteria, or exclude a user who shouldn't have access despite matching the conditions.
